...
export default function Home() {
  return (
    <div className="bg-slate-950 text-white min-h-screen">
      ...
      <nav className="fixed w-full top-0 z-50 bg-slate-900/80 backdrop-blur border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 text-gray-300">
            ...
            <a href="#process" className="hover:text-teal-400 transition">How It Works</a>
            <a href="#benefits" className="hover:text-teal-400 transition">Benefits</a>
          </div>
      ...
      <section
        id="home"
        className="pt-40 pb-28 text-center px-6 relative overflow-hidden bg-slate-950"
      >

        {/* animated gradient background */}

        <div className="absolute inset-0 bg-gradient-to-r from-teal-500/20 via-cyan-500/10 to-blue-500/20 blur-3xl opacity-30 animate-pulse"></div>

        <div className="relative z-10">

          <p className="inline-block px-4 py-1 bg-teal-500/10 text-teal-400 rounded-full mb-6">
            🚀 Hostel Management Reimagined
          </p>

          <h1 className="text-5xl md:text-6xl font-extrabold max-w-4xl mx-auto leading-tight">
  <span className="text-white">Smart Hostel </span>
  ...
  <span className="bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent">
    Complaint Management
          ...
          <div className="mt-10 flex justify-center">
            ...
            <Link
              to="/login"
              className="px-8 py-3 rounded-xl font-semibold bg-gradient-to-r from-teal-400 to-cyan-500 text-black shadow-lg shadow-teal-500/20 hover:scale-105 transition"
            >
              Get Started →
            </Link>
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-24">
        ...
        <p className="text-teal-400 text-center">Features</p>
      ...
      <section id="benefits" className="max-w-7xl mx-auto px-6 py-24">
        ...
        <p className="text-teal-400 text-center">Benefits</p>
...
function FeatureCard({ icon, title, text }) {
  return (
    <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-teal-400 hover:-translate-y-2 transition duration-300">
...
function Step({ icon, title, text }) {
  return (
    <div>
      <div className="w-16 h-16 flex items-center justify-center rounded-full bg-slate-800 text-teal-400 mx-auto mb-4">
        {icon}
      </div>
      <h3 className="font-semibold text-lg">{title}</h3>
...
function Benefit({ icon, title, text }) {
  return (
    <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl text-center hover:border-teal-400 hover:-translate-y-2 transition duration-300">
      <div className="text-teal-400 mb-4">{icon}</div>
      <h3 className="font-semibold text-lg">{title}</h3>
      <p className="text-gray-400 mt-2 text-sm">{text}</p>
    </div>
